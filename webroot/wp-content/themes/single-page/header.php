...
<div id="outer">
	<header id="site-header">
		<div id="menuW">
			<nav id="mainNav">
				<span><a id="site-name" href="<?php echo site_url(); ?>/home" class="navLink">Anna Olszewska</a></span>
				<ul>
				...
				<span><a id="info" href="#">Info</a></span>
			</nav>
		</div>
		<div id="info-box">
			<p>Contact:</p>
			<p><a id="mailC" href="mailto:anna@annaolszewska.com" target="_top">anna@annaolszewska.com</a></p>
			...
			<span class="tigger" id="closeInfo"></span>
		</div>
